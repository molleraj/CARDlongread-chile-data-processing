...
OUTPUT_VCF=${BASE_DIR}/VAMOS/${SAMPLE_ID}_pathogenic_vamos_102524.vcf
...
-r /data/CARDPB/data/adaptive_sampling/Madison_repeat/VAMOS/refined_pathogenic_repeats_102524.tsv \
-s ${SAMPLENAME} \
-o ${OUTPUT_VCF} \
-t 4
