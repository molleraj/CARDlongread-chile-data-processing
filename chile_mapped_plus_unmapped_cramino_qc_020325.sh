...
cramino -t 32 --ubam --reference /data/CARDPB/resources/hg38/GCA_000001405.15_GRCh38_no_alt_analysis_set.fa ${BASE_DIR}/MAPPED_BAM/${SAMPLE_ID}.sorted_meth.bam > ${BASE_DIR}/MAPPED_BAM/${SAMPLE_ID}_ubam_cramino_QC.txt
